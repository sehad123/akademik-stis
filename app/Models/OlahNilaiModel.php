...
class OlahNilaiModel extends Model
{
    ...
    static public function getRecordSingle($semester_id, $class_id, $matkul_id)
    {
        return self::where('semester_id', '=', $semester_id)->where('class_id', '=', $class_id)->where('matkul_id', '=', $matkul_id)->first();
    }
