...
class presensiModel extends Model
{
    ...
    {
        // $return =  presensiModel::select('presensi_mahasiswa.*', 'class.name as class_name', 'matkul.name as matkul_name', 'student.name as student_name', 'student.last_name as student_last_name', 'createdby.name as created_name')
