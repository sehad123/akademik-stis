                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-3">
                      <label >Class </label>
                      <select name="class_id" required id="getClass" class="form-control">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('dosen/presensi/student') }}" class="btn btn-success mt-4" type="submit">clear</a>
                    </div>
                  </div>
                </div>
              </form>
                ...
                <div class="card-body p-0">
                  <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        @php
                        $presensi_type = '';
                            $getPresensi = $value->getPresensi($value->id,Request::get('class_id'),Request::get('tgl_presensi'));
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('dosen/presensi/student/save') }}",
        data: {
            '_token': "{{ csrf_token() }}",
