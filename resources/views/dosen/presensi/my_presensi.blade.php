                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select name="presensi_type" id="getClass" class="form-control">
                        ...
                        <option value="6" {{ (Request::get('tgl_presensi') == 6)?'selected':'' }}>Tidak Hadir</option>
                      </select>
                    </div>
                    <div class="form-group col-md-3">
                      <button class="btn btn-primary mt-4" type="submit">Search</button>
                      <a href="{{ url('dosen/presensi/my_presensi') }}" class="btn btn-success mt-4" type="submit">Clear</a>
                    </div>
                  </div>
                </div>
              </form>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{ url('dosen/detail_perizinan/'.$value->id.'/'. Auth::user()->id .'/'. $value->class_id.'/'.$value->matkul_id) }}" class="btn btn-primary">Detail sakit / izin</a>
                        </td>
                        @endif
                      </tr>
                      @empty
