                        ...
                        <div class="card-body p-0">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $presensi_type = '';
                                    $created_at = '';
                                    $getPresensi = $value->getPresensi($getDosen->id, $getClass->id, now()->toDateString(), $getMatkul->id, $getDay->id);
...
var allowedRadius = 1000; // Radius yang diizinkan dalam meter
...
if (distance > allowedRadius) {
    ...
    if (presensi_type === 1 || presensi_type === 4 || presensi_type === 5) { // Hanya verifikasi wajah untuk presensi hadir
        ...
        video.addEventListener('loadeddata', function() {
            ...
            verifyFace(dataURL, dosen_id, presensi_type);
        });

        function verifyFace(imageData, dosen_id, presensi_type) {
            if (!dosen_id || !imageData) {
