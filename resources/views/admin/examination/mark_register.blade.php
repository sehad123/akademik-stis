                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('admin/examinations/mark_register') }}" class="btn btn-success mt-4" type="submit">clear</a>
                    </div>
                  </div>
                </div>
              </form>
...
<script type="text/javascript">
    ...
    //     $.ajax({
    //         type: "POST",
    //         url: "{{ url('admin/examinations/submit_mark') }}",
    //         data: formData,
    //         dataType: "json",
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('admin/examinations/single_submit_mark') }}",
        data: {
            '_token': "{{ csrf_token() }}",
            id : id,
