...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Laporan Presensi ({{ $getRecord->total() }})</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select name="presensi_type" id="getClass" class="form-control">
                        ...
                        <option value="2" {{ (Request::get('presensi_type') == 2)?'selected':'' }}>Terlambat</option>
                        <option value="3" {{ (Request::get('presensi_type') == 3)?'selected':'' }}>Sakit</option>
                        <option value="4" {{ (Request::get('presensi_type') == 4)?'selected':'' }}>Izin</option>
                        <option value="5" {{ (Request::get('presensi_type') == 5)?'selected':'' }}>Tidak Hadir</option>
                    </select>
                    </div>
                    <div class="form-group col-md-3">
